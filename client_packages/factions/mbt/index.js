...
mp.events.add("client:mbt:openMainMenu", (factionrang) => {
  mainMenujustiz = new Menu("Moonlight Beach","",MenuPoint);  
...
mp.events.add("client:mbt:closeMainMenu", () => {
  mainMenujustiz.Close();
});

mp.events.add("client:mbt:createOfficeComputer", (factionrang) => {
  const officeComputer = new Menu("Moonlight Beach","Computer",MenuPoint);
 officeComputer.AddItem(new UIMenuItem("Leitstelle","Leitstelle übernehmen/abgeben Nummer: 935"));
 if (factionrang > 1) {
  officeComputer.AddItem(new UIMenuItem("Mitarbeiter","Mitarbeiter von Moonlight Beach"));
 } 
...
mp.events.add("client:mbt:openMemberMenu", () => {
  memberMenujustiz = new Menu("Moonlight Beach","Mitarbeiterverwaltung",MenuPoint);
